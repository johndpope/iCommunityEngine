...
- (NSDictionary *)properties {
	...
	@catch (NSException * e) {
		//return [self dictionaryWithValuesForKeys:[[self class] propertyNames]];
		NSLog(@"FATAL: there's no data in your model. are you using an instance or static class?    [user saveRemoteWithCallback:@selector(onSaveUser:) delegate:self]; NOT [User ....];  %@",[[self class] propertyNames]);
